...
function UploadButton(prop) {
    ...
    return (
        <div style={{marginTop:"20px", width:"100%"}}>
            <Upload >
                <Button className="border" style={{ borderTopRightRadius: "20px", borderBottomRightRadius: "20px", borderTopLeftRadius: "20px", borderBottomLeftRadius: "20px", backgroundColor:"#EFD66BF2", color:"black" }} block icon={<UploadOutlined />}> Upload Supporting Documents</Button>
            </Upload>,
        </div>
    );
}
