...
import {
  Table, Input, Button, Popconfirm, Form, InputNumber, Select, Typography
} from 'antd';
...
class Page10F extends React.Component {
    ...
    render() {
      ...
      return (
        ...
        <div>
          <div style={{
            padding: '15px', backgroundColor: '#D5FFD5', boxShadow: '0 2px 6px', color: '#43425D'
          }}
          >
            Ministry of Education Generator Repair & Servicing
          </div>
          <div><TextArea rows={8} placeholder="Repair Details/Report" style={{ width: '100%' }} /></div>

          <div style={{
            padding: '15px', textAlign: 'left', backgroundColor: '#EFEFEF', boxShadow: '0 2px 6px', color: '#43425D'
          }}
          >
            Add Items Required
          </div>
            ...
            <div style={{ width: '33%', padding: '15px' }}>
              ...
              >
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                  ...
                  >
                    <InputNumber style={{
                      width: '90%', border: 'none', borderBottom: '1px solid', borderColor: '#D6D6D6'
                    }}
                    />
                  </Form.Item>
                ...
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                  <Form.Item style={{ width: '100%' }}>
                    <Button
                      ...
                      htmlType="submit"
                      style={{
                        backgroundColor: '#1C811C', borderColor: '#1C811C', color: 'white', width: '95%'
                      }}
                    >
                      Save Record
                    </Button>
                  ...
                  <Form.Item style={{ width: '100%' }}>
                    <Button
                      ...
                      style={{
                        backgroundColor: '#EFEFEF', borderColor: '#BCBCBC', color: 'black', width: '95%'
                      }}
                    >
                      Cancel
                    </Button>
